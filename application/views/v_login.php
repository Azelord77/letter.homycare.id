...
<head>
 ...
 <title>Login Homycare Letter</title>
...
<div class="login-box">
 ...
 <a href="<?php echo base_url();?>"><b>Homycare</b>Letter</a>
 </div>
 <!-- /.login-logo -->
 <?php
//  if (isset($GET['alert'])) {
...
// 	}
		...
		<p class="login-box-msg">Sign in to start Homycare Letter</p>
		...
		<div class="input-group mb-3">
		<input type="password" class="form-control" placeholder="Passwords" name="passwords" required>
		<div class="input-group-append">
		<div class="input-group-text">
